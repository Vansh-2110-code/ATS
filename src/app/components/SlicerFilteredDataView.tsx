    ...
    const fetchFilteredCandidates = async () => {
      ...
      try {
        ...
        if (slicerName === 'Today Uploads') {
          ...
          params.statusIn = 'Offer Accept,Offer Accepted,Offered,Offer Released,Waiting for Offer';
        } else if (slicerName === 'Offered / Selected' || slicerName === 'Offer Selected' || slicerName === 'offerSelected' || slicerName === 'offered') {
          params.statusIn = 'Document Initialized,Documennt Initialted,Documentation Completed,Documentation Incomplete,Waiting for Offer,Offer Accept,Offered,Offer Released,Offer Accepted,Document Pending,Documentation,Selected,L1 Select,L2 Select,Final Select,VNA Select,Client Select,Test Select';
          ...
          params.statusIn = 'Final Select,Final Round Scheduled,Final Round Completed,L1 Select,L2 Select,Test Select,VNA Select,Client Select,Selected';
        } else if (slicerName === '__waiting_for_offer_group') {
          params.statusIn = 'Offer Released,Yet To Join,Documentation in Progress,Documentation,Waiting for Offer';
